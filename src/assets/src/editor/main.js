...
require.config({
  ...
  paths: {
    ...
    'jquery.ui.resizable':
      '../bower_components/jquery-ui/ui/jquery.ui.resizable',
    ...
    texteditor_plugin_default_injection:
      'editor/plugins/injection/injection_default_plugin',
    texteditor_plugin_geogebra_injection:
      'editor/plugins/injection/injection_geogebra_plugin',
    deployggb: 'thirdparty/deployggb',
    texteditor_plugin_geogebratube_injection:
      'editor/plugins/injection/injection_geogebratube_plugin'
  },
  shim: {
    underscore: {
      exports: '_',
