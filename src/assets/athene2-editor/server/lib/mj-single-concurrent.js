...
MathJaxSingle = function () {
    ...
    var defaults = {
        ...
        timeout: process.env.MATHJAX_TYPESET_TIMEOUT || 10 * 1000             // 10 second timeout before restarting MathJax
    };
    ...
    function GetWindow() {
        ...
        //
        if (document._URL === "about:blank") {
            document._URL = "file:///blank.html";
        }
    }
    ...
    function GetSpeech(result) {
        ...
        if (data.mml) {
            ...
            if (jax.root.attrNames) {
                jax.root.attrNames.push("alttext")
            }
            result.mml = jax.root.toMathML('', jax);
        }
    }
    ...
    function GetPNG(result) {
        var svgfile = result.svgfile;
        delete result.svgfile;
        if (data.png) {
    ...
    /********************************************************************/
        ...
        //
    this.typeset = function (data, callback) {
