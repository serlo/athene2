(function () {
    var allowedTags = 'a|b|blockquote|code|del|dd|dl|dt|em|h1|h2|h3|h4|h5|h6|' +
            ...
            // tag is allowed
                ...
                params = params.replace(findAttribs, function(original, space,
                    ...
                    if ((name == "href" || name == "src") &&
                        (value.trim().substr(0, "javascript:".length) == "javascript:" || value.trim().substr(0, "data:".length) == "data:")) {
                        value = "#";
                    }

                    // scope links and sources to http protocol
                    if (forceProtocol &&
                        (name == "href" || name == "src") && !/^[a-zA-Z]{3,5}:\/\//.test(value)) {
                        value = "http://" + value;
                    }
