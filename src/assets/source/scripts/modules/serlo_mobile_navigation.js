...
/*global define*/
define('mobile_navigation', ['jquery', 'jquery-ui'], function ($) {
    'use strict';
    ...
    MobileNavigation = function (options) {
        ...
        this.$serloNav.append($('<li class="dropdown"><a href="#" data-toggle="dropdown">Serlo <b class="caret"></b></a></li>')
        ...
        this.copyNav('#serlo-menu .navbar-inner>ul', this.$serloNavDropdown, { skip: '.notifications, .authentication' });
        ...
        this.$mainNav.children().first().removeClass('is-hidden').addClass(this.options.navHeaderClass).click(function (e) {
            e.preventDefault();
        });
    ...
    MobileNavigation.prototype.copyNav = function (source, destination, params) {
        ...
        params = params ? $.extend({}, defaultParams, params) : $.extend({}, defaultParams);
    ...
    MobileNavigation.prototype.attachDropdownEventHandlers = function (el) {
        ...
        el.on('shown.bs.dropdown hidden.bs.dropdown', $(document).trigger('affix-refresh'));
    ...
    /**
     * MobileNavigation constructor wrapper
     * for creating a singleton
     */
    return function (options) {
        // singleton
        return instance || (function () {
                instance = new MobileNavigation(options);
                return instance;
            }());
    };
});
